/**
 * Updated seed script for Joe Street Cafe menu data.
 *
 * Usage:
 *   npx tsx src/scripts/seedMenuUpdated.ts
 *
 * Seeds 58 items across 14 categories.
 * Prices verified against menu page images (assets/menu-pages/).
 *
 * Changes from previous seed:
 * - Price corrections: Greek Frappe, Iced Latte, Iced Choco Latte/Oreo,
 *   Okinawa, Jjajangmyeon, Kimchi Ramen, Barkada platters, Street Bites/Fries
 * - Name corrections: "Iced Chocolate" -> "Iced Choco", noodles add "with Egg",
 *   Guava Fizz -> Guava Spritz, etc.
 * - New items: Mango Cloud Classic, Spam Fries
 * - New variants: Milk Tea Classics 12oz, French Fries Regular/Cheese,
 *   Street Bites Solo/Large
 * - Add-on corrections: Fish Cake 25->20, Siomai->Extra Siomai 20->30
 */
...
// ---------- Category definitions (14 categories) ----------
...
const menuItemsByCategory: Record<number, Omit<MenuItemSeed, 'categoryId' | 'station' | 'isAvailable'>[]> = {
  ...
  1: [
    ...
    { name: 'Greek Frappe', basePrice: 89, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Iced Latte', basePrice: 99, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Dalgona', basePrice: 99, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Caramel Macchiato', basePrice: 109, variants: [{ name: 'Regular', priceAdd: 0 }] },
  ],
  ...
  3: [
    { name: 'Iced Choco', basePrice: 89, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Iced Choco Latte', basePrice: 105, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Iced Choco Oreo', basePrice: 115, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Iced Choco Strawberry', basePrice: 115, variants: [{ name: 'Regular', priceAdd: 0 }] },
  ],
  // 4: Milk Teas - Classics (4 items) — 12oz available at P49
  4: [
    { name: 'Wintermelon', basePrice: 75, variants: [{ name: '12oz', priceAdd: -26 }, { name: '16oz', priceAdd: 0 }] },
    { name: 'Okinawa', basePrice: 79, variants: [{ name: '12oz', priceAdd: -30 }, { name: '16oz', priceAdd: 0 }] },
    { name: 'Taro', basePrice: 79, variants: [{ name: '12oz', priceAdd: -30 }, { name: '16oz', priceAdd: 0 }] },
    { name: 'Cookies & Cream Milk Tea', basePrice: 99, variants: [{ name: '12oz', priceAdd: -50 }, { name: '16oz', priceAdd: 0 }] },
  ],
  // 5: Milk Teas - Mango Series (7 items)
  5: [
    { name: 'Mango Milk Tea', basePrice: 95, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Iced Choco Mango', basePrice: 99, variants: [{ name: 'Regular', priceAdd: 0 }] },
    ...
    { name: 'Mango Cloud Classic', basePrice: 69, variants: [{ name: 'Regular', priceAdd: 0 }], description: 'Buy 1 Take 1 (12oz only)' },
    { name: 'Mango Berry Cloud', basePrice: 69, variants: [{ name: 'Regular', priceAdd: 0 }], description: 'Buy 1 Take 1 (12oz only)' },
    { name: 'Mango Citrus Cloud', basePrice: 69, variants: [{ name: 'Regular', priceAdd: 0 }], description: 'Buy 1 Take 1 (12oz only)' },
  ],
  // 6: Milk Teas - Matcha Series (4 items)
  6: [
    { name: 'Matcha Latte', basePrice: 99, variants: [{ name: 'Regular', priceAdd: 0 }] },
  ...
  // 7: Street Fizz (10 items) — 12oz=P69, 16oz=P79
  7: [
    ...
    { name: 'Guava Spritz', basePrice: 69, variants: [{ name: '12oz', priceAdd: 0 }, { name: '16oz', priceAdd: 10 }] },
  ...
  9: [
    { name: 'Jjajangmyeon with Egg', basePrice: 159, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Kimchi Ramen with Egg', basePrice: 159, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'Buldak Cheese with Egg', basePrice: 179, variants: [{ name: 'Regular', priceAdd: 0 }] },
  ...
  11: [
    { name: 'Pinoy Barkada Platter', basePrice: 329, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'K-Barkada Platter', basePrice: 429, variants: [{ name: 'Regular', priceAdd: 0 }] },
  ],
  // 12: Pitcher (2 items)
  12: [
  ...
  // 13: Street Bites (4 items)
  13: [
    { name: 'Spam Fries', basePrice: 125, variants: [{ name: 'Regular', priceAdd: 0 }] },
    { name: 'French Fries Solo', basePrice: 35, variants: [{ name: 'Regular', priceAdd: 0 }, { name: 'Cheese', priceAdd: 4 }] },
    { name: 'French Fries Large', basePrice: 65, variants: [{ name: 'Regular', priceAdd: 0 }, { name: 'Cheese', priceAdd: 10 }] },
    { name: 'Street Bites', basePrice: 60, variants: [{ name: 'Solo', priceAdd: 0 }, { name: 'Large', priceAdd: 55 }] },
  ],
};
...
async function seed() {
  console.log('Starting seed... (58 items across 14 categories)');
  ...
  const addOnGroups: AddOnGroupSeed[] = [
    {
      ...
      items: [
        ...
        { name: 'Extra Siomai (4 pcs)', price: 30 },
